  ...
  return (
    <>
      <div className={`personal_details`}>
        <div className="crossmenubar" onClick={() => setActive(false)}>  <i className="fa-solid fa-xmark"></i></div>
        ...
        <div className="social-icons">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="i_tag_social facebook" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
          </a>
        </div>
        {/* border line */}
        ...
        <div className="button_resume">
          ...
          >
            <button>
              Download Resume
              <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" className="hioutlinedown" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
            </button>
          </a>
        </div>
      </div>
